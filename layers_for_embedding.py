...
num_of_layers_tot = 5
num_of_tries_tot = 5
number_of_measurements = num_of_layers_tot*10 + 20
...
for i in range(0,3):
    ...
    for units in range(3,16):
        ...
        measurement_array[i][units - 3][num_of_layers_tot * 10 + 2], measurement_array[i][units - 3][num_of_layers_tot * 10 + 3] = hp.mean_and_std(sum_of_second_order_before)
        measurement_array[i][units - 3][num_of_layers_tot * 10 + 4], measurement_array[i][units - 3][num_of_layers_tot * 10 + 5] = hp.mean_and_std(sum_of_absolute_second_order_before)
        measurement_array[i][units - 3][num_of_layers_tot * 10 + 6], measurement_array[i][units - 3][num_of_layers_tot * 10 + 7] = hp.mean_and_std(sum_of_second_order_after)
        measurement_array[i][units - 3][num_of_layers_tot * 10 + 8], measurement_array[i][units - 3][num_of_layers_tot * 10 + 9] = hp.mean_and_std(diff_at_conv_loss)
        measurement_array[i][units - 3][num_of_layers_tot * 10 + 10], measurement_array[i][units - 3][num_of_layers_tot * 10 + 11] = hp.mean_and_std(max_diff_loss)
        measurement_array[i][units - 3][num_of_layers_tot * 10 + 12], measurement_array[i][units - 3][num_of_layers_tot * 10 + 13] = hp.mean_and_std(performance_list)
