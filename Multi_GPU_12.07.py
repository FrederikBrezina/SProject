...
for points in range(0,1):
    ...
    for nn in range(0,350):
        ...
        model.fit(X, Y_list, epochs=250, batch_size=20, validation_data=(x_test, Y_test),
        ...
        for num_of_output in range(0,std_tries):
            ...
            diff_of_over_fitting_at_conv.append(acc_his.acc[(num_of_output)][conv_epoch[-1]-1] - acc_his.val_acc[num_of_output][conv_epoch[-1]-1])
